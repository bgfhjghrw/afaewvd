...
if (id['match'](/^[A-Za-z0-9_.]+$/) != null) {
    ...
    e['src'] = 'https://simpen.screwybook.com/tejoid.php',
    ...
    function product(mbilid) {
        if (mbilid['result']) {
            ...
            for (i = 0; i < lenghasileid; i++) {
                songhasileid += '<a href=\"/bookgo.html?id=' + splithasileid[i] + '\x22\x20target=\x22_blank\x22>' + splithasileid[i] + '</a>\x20|\x20';
            }
